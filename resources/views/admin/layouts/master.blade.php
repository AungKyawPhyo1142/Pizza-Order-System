                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            @if (Auth::user()->image == null)
                                                <img src="{{asset('image/default_profile.png')}}" alt="Default User Profile Picture" />
                                            @else
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{route('admin#showAdminList')}}">
                                            ...
                                            <div class="account-dropdown__footer my-3">
                                                <form action="{{route('logout')}}" method="POST" class="d-flex justify-content-center">
                                                    ...
                                                    <button class="btn btn-dark text-white col-10" type="submit">
                                                        <i class="zmdi zmdi-power"></i> <span class="mx-2">Logout</span>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
