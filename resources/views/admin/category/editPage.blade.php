                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('category#update')}}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="categoryName" type="text" value="{{$data->name}}" class="form-control @error('categoryName') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Seafood...">
                                    @error('categoryName')
